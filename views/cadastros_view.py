...
class Cadastros(QWidget):
    def __init__(self):
        ...
        self.tabela_categorias.setColumnHidden(0, True)
        ...
        self.tabela_materiais.setColumnHidden(0, True)
    ...
    def limpar_campo_c(self):
        ...
        self.tabela_categorias.setCurrentCell(-1, -1)
    ...
    def limpar_campo_m(self):
        ...
        self.tabela_materiais.setCurrentCell(-1, -1)
        self.id_editando = None
    ...
    def excluir_categoria(self):
        ...
        id_categoria = self.tabela_categorias.item(linha, 0).text()  # pega o id primeiro
    ...
    def excluir_material(self):
        ...
        id_material = self.tabela_materiais.item(linha, 0).text()  # pega o id primeiro
        conn = get_connection()                        # abre conexão
        cursor = conn.cursor()                         # cria cursor
